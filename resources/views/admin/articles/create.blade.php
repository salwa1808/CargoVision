...
<div class="container py-4">
    ...
    <!-- Title Header -->
    <div class="mb-4">
        <h1 class="h3 text-white mb-1 fw-bold">➕ New Article</h1>
        <p class="text-muted small">Create and publish new content to the supply chain news platform.</p>
    </div>
            ...
            <div class="col-lg-8">
                <div class="editor-card">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="titleInput" class="form-control" placeholder="Enter title..." required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label text-muted small fw-bold text-uppercase">Slug Preview</label>
                        <input type="text" id="slugPreview" class="form-control" readonly style="opacity: 0.5;">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="summary" class="form-control" rows="2" placeholder="Brief summary of the article..."></textarea>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="editor-card mb-4">
                    ...
                    <div class="thumb-upload-area" onclick="document.getElementById('thumbnailFileInput').click()">
                        ...
                        <p class="text-muted small mb-0 mt-2">Click to upload thumbnail image</p>
                        <input type="file" id="thumbnailFileInput" accept="image/*" class="d-none">
                        <input type="hidden" name="thumbnail" id="thumbnailBase64">
                    </div>
                    <div class="text-center">
                        <img src="" id="thumbPreview" class="thumb-preview d-none" alt="Thumbnail Preview">
                    </div>
                </div>
                ...
                <div class="editor-card">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="meta_keywords" class="form-control" placeholder="supply, chain, risk...">
                    </div>
                </div>

...
<head>
    ...
    <title>Register - Global Supply Chain Risk Platform</title>
...
<div class="register-container">
    <div class="glass-card">
        <div class="brand-logo-wrapper">
            ...
            <span class="brand-subtitle">Registration Portal</span>
        </div>
        ...
        <div class="text-center mt-4">
            ...
            <a href="{{ url('/login') }}" class="text-decoration-none small" style="color: #c084fc; font-weight: 600;">Sign in</a>
        </div>
    </div>
</div>
